	...
	for(let t = 0; t < window.task_queue.length; t++){
		...
		if(typeof window.task_queue[t].assistant == 'string'){
			if(window.task_queue[t].assistant.startsWith('custom_saved')){
				...
				assistant_icon_el.src = 'images/' + window.task_queue[t].assistant.replace('_32bit','') + '.png';
				assistant_icon_el.setAttribute('alt',get_translation(window.task_queue[t].assistant + '_name'));
